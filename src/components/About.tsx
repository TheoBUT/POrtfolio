        ...
        <div className="space-y-8">
          <div className="bg-gradient-to-br from-slate-800 to-blue-900 p-6 rounded-2xl shadow-lg text-white">
            ...
            <p className="text-gray-200 leading-relaxed">
              Passionné par la cybersécurité, je suis actuellement 
              étudiant en BUT Informatique parcours déploiement d'applications communicantes et sécurisées. 
              et futur étudiant en Master Sécurité informatique, cybersécurité et cybermenaces.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-cyan-50 to-blue-50 p-6 rounded-2xl shadow-lg border border-cyan-200">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              <strong>2024-2025 :</strong> BUT Informatique - Déploiement d'applications communicantes et sécurisées<br />
              <strong>2022-2024 :</strong> BTS SIO - Solutions d'infrastructures Systèmes et Réseaux<br />
